...
namespace Solcery.BrickInterpretation.Runtime
{
    public interface IServiceBricks
    {
        ...
        void RegistrationBrickType(BrickTypes type, BrickJKeyValueTypes subType, Func<int, int, Brick> created, uint capacity = 1);
        void RegistrationBrickType(BrickTypes type, BrickJTokenTypes subType, Func<int, int, Brick> created, uint capacity = 1);
